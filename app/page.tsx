  ...
  return (
    <main id="main-content" className="home-page">
      ...
      <div className="home-grid">
        ...
        <Tile href="/workprojects" title="Work projects" description="Internal tools, training and integrations. A closer look at my professional work." className="tile-half featured" icon={<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="14" width="7" height="7" rx="1.5"/><path d="M10 6h5a3 3 0 0 1 3 3v5M6 10v5a3 3 0 0 0 3 3h5"/></svg>} />
